...
ax1.plot(log_nu_stev, log_lum_stev, 'g--')
ax1.plot(log_nu_wink, log_lum_wink, 'g--')
ax1.set_ylim(28.4,29)
ax2 = ax1.twinx()
ax3 = ax2.twiny()
ax3.set_xlabel(r"$\log(R)$")
ax3.plot(log_r_femm, log_T_arr_575, "k-")
ax3.plot((LOG_R_MIN, LOG_R_MIN), (T_rad5(LOG_R_MIN-log_r_scale,inflect,beta_in,beta_out,t_inflect), 10), 'k:')
ax3.plot((LOG_R_MAX, LOG_R_MAX), (T_rad5(LOG_R_MAX-log_r_scale,inflect,beta_in,beta_out,t_inflect), 10), 'k:')
ax3.plot(inflect+log_r_scale,t_inflect,'ok')
...
#finding the where the functions reaches maximum
    ...
    ax1.plot(log_r_femm, emm_arr, colors[num]+'-')
"""
ax2.set_ylim(3.9,5.2)
#ax3.set_xlim(13.5,15.5)
...
#plt.show()
plt.savefig('SED_fit_fig.eps', bbox_inches='tight')
