...
MIN_LOG_NU = 14.6
MAX_LOG_NU = 15.8
MIN_LOG_R = 12.2 #Moves SED to right/left (higher frequency)
MAX_LOG_R = 13.72 #Decreasing moves it up/right

log_lum_norm = 28.96 #point on observed SED used to normalize
log_nu_norm = 15
...
t_inflect = 3.65 #increasing moves SED to right
inflect =14.45 #Up and Down
beta_in = 0.55
beta_out = 0.6
...
xlabel = ax1.set_xlabel("\log(nu)")
xlabel.set_color('r')
ylabel = ax1.set_ylabel("\log(L)")
ylabel.set_color('r')
...
"""
ax2.set_ylim(4,5)
ax3.set_xlim(LOG_R_MAX+1,LOG_R_MIN-1)
