...
MAX_LOG_R = 21.5 #Decreasing moves it up/right
...
plt.errorbar(lambda_5548, tau_5548, yerr=tau_err_5548, fmt = 'o')
plt.show()
...
ax2.plot(log_r_femm, log_T_arr_75, "k-")
ax2.set_ylabel(r"$\log(T)$", color = "k")
for tl in ax2.get_yticklabels():
    tl.set_color("k")
plt.xlim(12,17)
plt.show()
#plt.savefig('emmisivity_fig.eps', bbox_inches='tight')
